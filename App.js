...
function MainTabs() {
  return (
    <Tab.Navigator screenOptions={{
      ...
      <Tab.Screen name="CurrentData" component={CurrentDataScreen} options={{ title:'CUR. DATA',  headerTitle:'CURRENT DATA — G4HG',  tabBarIcon:({color})=><Text style={{color,fontSize:20}}>📊</Text> }}/>
